...
async function testTriggerEndpoint(): Promise<string | null> {
...
async function testGetSettlement(settlementId: string): Promise<void> {
...
async function testListSettlements(): Promise<void> {
